...
class AdaptiveLogitsWarper(LogitsWarper):
    ...
    >>> # With `ada` sampling, the output gets restricted to high-rational tokens.
    >>> # Pro tip: In practice, LLMs use `ada` in the 0.0005-0.01 range.
    >>> outputs = model.generate(**inputs, do_sample=True, ada=0.1)
