...
class GenerationMixin:
    ...
    def _get_logits_warper(
        ...
        if generation_config.ada is not None and generation_config.ada < 1.0:
            warpers.append(AdaptiveLogitsWarper(ada=generation_config.ada, min_tokens_to_keep=min_tokens_to_keep))
